        ...
        with slim.arg_scope([slim.conv2d],
            ...
            for i in range(4):
                if i == 0:
                    ...
                    C[3] = slim.conv2d(tf.concat([F2[3], f[2]], axis=-1), 64, 1)
                    H2[2] = slim.conv2d(C[3], 64, 3)

                    F2[2] = max_pool_2x2(H2[2])

                    f[1] = tf.concat([F2[2], f[1]], axis=-1)
            ...
            g[3]=Bilstm(g[3],num_outputs[3],128,num_outputs[3], scope_name='BiLSTM')
